  ...
  return (
    <>
      ...
      <p>
        ...
        {
          " While AI safety is not underfunded in absolute terms, it certainly is, relative to the capital dedicated to push frontier capabilities. Safety at most frontier labs are ad-addendum to the core training process due to a lack of financial incentive to push alignment as far as capabilities "
        }
        <a href={"https://techcrunch.com/2026/02/14/is-safety-is-dead-at-xai/"}>
          {"[24]"}
        </a>
        {
          ". Highly capable Chinese open weight models are released on the open internet. Multi-agent behavior shows swarms of models can pursue complex tasks via unaligned means, through cooperation. "
        }
      ...
      <p>
        {
          "As with nuclear weapons, attempts at cooperative deceleration - such as nuclear non-proliferation, have scarcely prevented actors from covertly developing capabilities. Pursuing strong command and control mechanisms however, as with PALs, seem to be one of the few ways that have mitigated the risk of potentially catastrophic technologies. PALs have ensured that nuclear weapons cannot be detonated by rogue actors and have prevented capabilities from being accidentally activated and used discreetly. Notably, PALs and C2 technologies were not simply a logical continuation off the back of prior technology, they were intentionally funded and led by the government. Just as the future of AI will likely also be steered by the willpower of researchers and policymakers, to cooperate on alignment research and contain capabilities. "
        }
      </p>
